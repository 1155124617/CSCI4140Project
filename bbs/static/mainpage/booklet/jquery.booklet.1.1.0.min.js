...
(function (b) {
    ...
    function a(ac, ae, G) {
        ...
        if (!av.width) { av.width = S.width() }
        if (!av.height) { av.height = S.height() }
        S.width(av.width);
        S.height(av.height);
        ...
        if (av.direction == "LTR") {
            ...
            if (av.direction == "RTL") { av.curr = av.pTotal - 2 }
        } if (!isNaN(av.startingPage) && av.startingPage <= av.pTotal && av.startingPage > 0) {
            if ((av.startingPage % 2) != 0) { av.startingPage-- } av.curr = av.startingPage
        } if (av.name) {
